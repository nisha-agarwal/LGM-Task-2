  ...
  return (
    <div>
      ...
      <div className="section">
              ...
              <div className="col s12 m7">
                <div className="card">
                  ...
                  <div className="card-content">
                    <p>Hello Everyone, My name is <b>{user.first_name}</b>!</p>
                  </div>
        ...
        {hasMoreItems ? "" : <div id="sec_load" style={{ display: 'flex', justifyContent: 'center' }} className="text-center"><h5>Thats all we could fetch.</h5></div>}
      </div>
    </div>
  )
}